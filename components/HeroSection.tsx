      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="max-w-xl">
            ...
            >
              Discover <span className="text-green-600">Elegance</span>
              <br />
              in Every <span className="text-green-600">Saree</span>
            </h1>
            ...
            >
              Premium quality sarees crafted for the modern woman. Blending timeless tradition with contemporary style.
            </p>
            ...
            >
              {/* Primary Button */}
              <Button 
                className="bg-green-600 hover:bg-green-700 text-white h-13 px-8 rounded-lg text-base font-medium transition-all duration-300 shadow-lg shadow-green-600/25 group hover:shadow-xl hover:-translate-y-0.5"
              >
                Shop Now 
            ...
            >
              {[
                ...
                <div key={idx} className="relative flex items-center">
                  <div>
                    <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">{stat.value}</h3>
                    <p className="text-xs sm:text-sm text-gray-500 mt-1 font-medium">{stat.label}</p>
                  </div>
                  {/* Divider line for first two items */}
                  {idx !== 2 && <div className="absolute -right-4 sm:-right-6 w-px h-12 bg-gray-200 hidden sm:block" />}
                </div>
              ))}
            </div>
          </div>
          ...
          >
            <div className="relative w-full max-w-[420px] group">
              ...
              >
                <p className="text-[11px] text-gray-500 font-medium mb-0.5">Starting from</p>
                <p className="text-green-600 font-bold text-base tracking-tight">৳1,299</p>
              </div>
              ...
              <div 
                ...
                style={{ animation: 'heroFloatSlow 4s ease-in-out infinite', animationDelay: '1s' }}
              >
                ...
                <div>
                  <p className="text-sm font-bold text-gray-900 leading-tight">500+ Happy</p>
                  <p className="text-[11px] font-medium text-gray-500 mt-0.5">Customers</p>
                </div>
              </div>
