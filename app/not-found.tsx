  ...
  return (
    <main className="min-h-screen flex flex-col ">
      <section className="relative flex-1 flex items-center justify-center overflow-hidden py-32">
        ...
        <div className="absolute inset-0 -z-10 bg-[linear-linear(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-size-[32px_32px]" />

        {/* Glowing Effect */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-200 h-200 bg-primary/5 rounded-full blur-[140px]" />
        ...
        <div className="container px-6 mx-auto relative z-10">
          <div className="max-w-3xl mx-auto text-center space-y-12">
            ...
            <div className="relative">
              ...
              <div className="relative p-12 rounded-[2.5rem] bg-linear-to-br from-card/60 to-card/40 border-2 border-white/10 backdrop-blur-2xl space-y-6 shadow-2xl">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-muted-foreground max-w-md mx-auto leading-relaxed">
                    The knowledge you&apos;re seeking has drifted beyond our
                    archive. This entry doesn&apos;t exist in our vault.
                  </p>
                </div>
                ...
                <div className="p-6 rounded-2xl bg-muted/80 border-2 border-white/10 font-mono text-left max-w-lg mx-auto shadow-lg">
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="text-muted-foreground/50 text-xs pl-4">
                      Suggestion: Return to myShop index
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="pt-8 border-t border-white/10">
              <div className="grid grid-cols-3 gap-6 max-w-2xl mx-auto">
                <div className="p-4 rounded-2xl bg-linear-to-br from-card/60 to-card/40 border-2 border-white/10 shadow-lg">
